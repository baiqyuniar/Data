...
def pencatatan(i, waktu, mess, simon):
...
def on_connect(client, userdata, flags, rc, properties=None):
    ...
    if("%s", rc == "Success"):
        for i in range (5) : 
            ...
            pencatatan(str(i), now, mess, simon)
...
client = paho.Client(client_id="clientId-7GWFTtedw0", userdata=None, protocol=paho.MQTTv5) #transport='websockets'
